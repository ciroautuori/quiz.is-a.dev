          ...
          <div className="p-5 overflow-y-auto space-y-6 flex-1">
            ...
            <div>
              <h3 className="text-xs font-mono font-bold uppercase tracking-wider mb-3 flex items-center justify-between" style={{ color: 'var(--ctp-subtext0)' }}>
                <span>{t.weeklyLeaderboard} - {currentLeagueConfig.name}</span>
                <span className="text-[10px] text-emerald-400">
                  {t.promotionRelegation}
                </span>
              </h3>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span style={{ color: 'var(--ctp-text)' }}>
                          {displayName} {isUser && <span className="text-[10px] text-[var(--ctp-mauve)] font-normal">({t.youShort})</span>}
                        </span>
                      </div>
