          ...
          >
            ...
            <div className="p-4 border-b border-[var(--ctp-surface1)] ctp-card-mantle flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <button onClick={() => setTtsEnabled(!ttsEnabled)} className={`p-1.5 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors ${ttsEnabled ? 'text-indigo-500' : 'text-gray-500'}`} title={t.toggleTts}><Volume2 className="w-4 h-4" /></button>
                <button
                  onClick={clearChat}
                  title={t.clearChat}
