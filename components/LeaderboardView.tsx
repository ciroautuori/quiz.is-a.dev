...
export default function LeaderboardView() {
  ...
  return (
    <div className="max-w-5xl mx-auto py-6 px-4 space-y-6 lg:space-y-0 lg:grid lg:grid-cols-12 lg:gap-8 items-start">
      {/* Left Column: Proficiency Radar Chart */}
      <div className="lg:col-span-5 ctp-card p-6 rounded-2xl border shadow-xl" style={{ borderColor: 'var(--ctp-border)' }}>
